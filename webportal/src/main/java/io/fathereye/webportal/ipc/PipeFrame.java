...
/**
 * Mirror of bridge {@code Frame} wire format. Copied verbatim from the
 * panel's {@code io.fathereye.panel.ipc.PipeFrame} so the web portal speaks
 * the exact same length-prefixed codec-tagged frames the bridge expects.
 */
